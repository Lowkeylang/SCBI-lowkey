...
function ChatSupport()
    ...
    Brodcast Channel : https://t.me/

    Chat Support : https://t.me/
]], "Get Chat Link", "Brodcast Channel")

    gg.setVisible(false)
    if chooseSupport == 2 then
        gg.copyText("https://t.me/")
    else
        gg.copyText("https://t.me/")
    end
end
...
function UpdateCheck()
    ...
    codeFromServer = gg.makeRequest('https://raw.githubusercontent.com/Lowkeylang/SCBI-lowkey/refs/heads/main/SCBI_lowkey_000.lua').content
